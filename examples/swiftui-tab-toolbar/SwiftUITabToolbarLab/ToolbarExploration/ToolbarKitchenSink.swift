...
/// - .status: Centered, informational status
  ...
  var body: some View {
    NavigationStack {
      ...
      .toolbar {
        ...
        // .status is semantic, informational content. On iOS and iPadOS,
        // the system places it in the center of the bottom toolbar.
